...
We've designed td-js-sdk in such a way that you can make a lightweight wrapper. You can see an example of this in `examples/wrapper`. The main file of interest being `examples/wrapper/lib/index.js`.
