...
(()=>{var p=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var u=p(i=>{(function(e,t){if(t[e]===void 0){t[e]=function(){t[e].clients.push(this),this._init=[Array.prototype.slice.call(arguments)]},t[e].clients=[];for(var l=function(s){return function(){return this["_"+s]=this["_"+s]||[],this["_"+s].push(Array.prototype.slice.call(arguments)),this}},a=["addRecord","blockEvents","fetchServerCookie","fetchGlobalID","fetchUserSegments","resetUUID","ready","setSignedMode","setAnonymousMode","set","trackEvent","trackPageview","trackClicks","unblockEvents"],n=0;n<a.length;n++){var c=a[n];t[e].prototype[c]=l(c)}var r=document.createElement("script");r.type="text/javascript",r.async=!0,r.src=(document.location.protocol==="https:"?"https:":"http:")+"@URL";var o=document.getElementsByTagName("script")[0];o.parentNode.insertBefore(r,o)}})("@GLOBAL",i)});u();})();
</script>
```
