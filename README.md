...
!function(t,e){if(void 0===e[t]){e[t]=function(){e[t].clients.push(this),this._init=[Array.prototype.slice.call(arguments)]},e[t].clients=[];for(var n=function(t){return function(){return this["_"+t]=this["_"+t]||[],this["_"+t].push(Array.prototype.slice.call(arguments)),this}},o=["blockEvents","fetchServerCookie","unblockEvents","setSignedMode","setAnonymousMode","resetUUID","addRecord","fetchGlobalID","set","trackEvent","trackPageview","trackClicks","ready"],r=0;r<o.length;r++){var c=o[r];e[t].prototype[c]=n(c)}var a,i,s,d,l,u=document.currentScript||document.getElementsByTagName("script")[0],m=document.createElement("iframe"),p="td-iframe-async";m.src="javascript:false",m.title="",m.role="presentation",d=(m.frameElement||m).style,d.width=0,d.height=0,d.border=0,d.display="none",u.parentNode.insertBefore(m,u);try{a=m.contentWindow,i=a.document.open()}catch(h){s=document.domain,m.src='javascript:var d=document.open();d.domain="'+s+'";void(0);',a=m.contentWindow,i=a.document.open()}l=function(){var t=i.createElement("script");t.id=p,t.src=("https:"===document.location.protocol?"https:":"http:")+"//cdn.treasuredata.com/sdk/2.3/td.min.js",i.body.appendChild(t)};try{a._l=l,a.addEventListener?a.addEventListener("load",a._l,!1):a.attachEvent&&a.attachEvent("onload",a._l)}catch(v){i._l=function(){s&&(this.domain=s),l()},i.write('<body onload="document._l();">')}i.close()}}("Treasure",this);
</script>
```
