...
exports.blockEvents = function blockEvents () {
  setCookie.setCookie(this.client.storage, BLOCKEVENTSCOOKIE, 'true')
}
...
exports.unblockEvents = function unblockEvents () {
  setCookie.setCookie(this.client.storage, BLOCKEVENTSCOOKIE, 'false')
}
...
exports.areEventsBlocked = function areEventsBlocked () {
  return this.getCookie(BLOCKEVENTSCOOKIE) === 'true'
}
...
exports.setSignedMode = function setSignedMode (signedMode) {
  setCookie.setCookie(this.client.storage, SIGNEDMODECOOKIE, 'true')
  return this
}
...
exports.setAnonymousMode = function setAnonymousMode (signedMode) {
  setCookie.setCookie(this.client.storage, SIGNEDMODECOOKIE, 'false')
  return this
}
...
exports.inSignedMode = function inSignedMode () {
  return (
    this.getCookie(SIGNEDMODECOOKIE) !== 'false' &&
    (this.getCookie(SIGNEDMODECOOKIE) === 'true' ||
