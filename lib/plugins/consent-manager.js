...
/**
 * @Treasure consent-manager/saveContexts
 * Save the contexts to the local storage and to the Treasure Data platform
 * @exports consentManager.saveContexts
 * 
...
/**
 * @Treasure.getConsents
 * 
 * @returns return list of consents
 */
  getConsents () {
...
/**
 * @Treasure.getContexts
 * 
 * @returns return list of contexts
 * 
 */
  getContexts () {
    const preferences = !_.isEmpty(this.consentManager.preferences) ? this.consentManager.preferences : this.getPreferences()
 ...
 * @property this is a test againv2
 * 
 * */

/**
 * @Treasure.getExpiredConsents
 * @returns Returns expired consents
 * 
 */
  getExpiredConsents () {
