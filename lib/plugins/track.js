...
exports.configure = function configure (config) {
  if (!this.client._recordConfigured) {
    this.configure(this.Plugins.Records, config)
  }
  config = _.assign({
    _trackConfigured: true
  }, config)

  // Object configuration for track and storage
  this.client._trackConfigured = true
...
exports.trackEvent = function trackEvent (table, record, success, failure) {
  if (!this.client._trackConfigured) {
    this.log('Track plugin must be configured before using')
    return this
  }
