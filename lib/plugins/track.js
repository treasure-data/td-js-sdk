 ...
 *    - defaults to 'events'
 * config.universalIdHost (String)
 *    - Hostname of Universal ID Gateway
 *    - By setting this, it enables Universal ID
 *    - defaults to null
 *
 */
...
exports.trackEvent = function trackEvent (table, record, success, failure) {
  ...
  if (this.client.universalIdHost) {
    var data1, data2, this0 = this
    jsonp("https://"+this.client.universalIdHost+"/ssl_session_id?random="+Math.random(), {
      prefix: 'TreasureJSONPCallback',
      timeout: 10000 // 10 seconds timeout
    }, function (err, res) {
      if (!err) data1 = res
      jsonp("https://pin.freetls.fastly.net/pin.js?random="+Math.random(), {
        prefix: 'TreasureJSONPCallback',
        timeout: 10000 // 10 seconds timeout
      }, function (err2, res2) {
        if (!err2) data2 = res2
        record = _.assign({}, data1, data2, record)
        this0.addRecord(table, record, success, failure)
      })
    })
  } else {
