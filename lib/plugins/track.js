 ...
 *
 * Sets the user's anonymous mode
 */
exports.setAnonymousMode = function setAnonymousMode (anonymousMode) {
  if (anonymousMode) {
    cookie.setItem('__anonymous', 'true')
  } else {
    cookie.setItem('__anonymous', 'false')
  }
}
 ...
 */
exports.getAnonymousMode = function getAnonymousMode () {
  return cookie.getItem('__anonymous') === 'true'
}
...
exports.getTrackValues = function getTrackValues () {
  var result = {}
  var isAnonymous = this.getAnonymousMode()
  _.forIn(this.client.track.values, function (value, key) {
    if (value && !(isAnonymous && (value === 'td_ip' || value === 'td_client_id'))) {
