...
function validateOptions(options) {
  ...
  var customized = !_.isEqual(exports.DEFAULT_CONFIG, generateDefaultConfig());

  // options must be an object unless it is customized
  if (!_.isObject(options) || (!options && !customized)) {
