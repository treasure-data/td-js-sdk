 ...
 */
exports.configure = function configure (plugin, config) {
  if (!(this.client && this.client._configured)) {
    this.client = _.assign({
      _configured: true,
      globals: {}
    }, this.client, exports.DEFAULT_CONFIG, {
      requestType: 'jsonp'
    })
  }
  if (plugin._isPlugin) {
    var configureFn = plugin.configure || _.noop
    configureFn.call(this, config)
  } else {
    config = plugin
    this.client = _.assign(this.client, config)
  }
  return this
}
